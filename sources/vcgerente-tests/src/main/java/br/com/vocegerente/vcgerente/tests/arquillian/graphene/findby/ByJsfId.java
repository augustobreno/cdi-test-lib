 ...
 */
package br.com.vocegerente.vcgerente.tests.arquillian.graphene.findby;
 ...
 * @author David Vieira
 */
@ImplementedBy(className = "br.com.vocegerente.vcgerente.tests.arquillian.graphene.findby.ByJsfIdImpl")
