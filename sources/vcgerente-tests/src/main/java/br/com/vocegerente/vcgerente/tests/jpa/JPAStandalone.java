...
public class JPAStandalone {
	...
	/** Para realização de consultas utilitárias à base de dados. Este {@link QuerierUtil} estará sempre configurado
	 * com o {@link EntityManager} associado a este {@link JPAStandalone}. */
	...
	public QuerierUtil getQuerier() {
		if (this.querier == null) {
			this.querier = new QuerierUtil(getEm());
		}
		return querier;
	}
