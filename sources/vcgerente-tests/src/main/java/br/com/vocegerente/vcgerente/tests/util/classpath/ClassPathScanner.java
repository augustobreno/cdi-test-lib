package br.com.vocegerente.vcgerente.tests.util.classpath;
...
public class ClassPathScanner {
	...
	private static final Logger logger = LogManager.getLogManager().getLogger(ClassPathScanner.class.getName());
