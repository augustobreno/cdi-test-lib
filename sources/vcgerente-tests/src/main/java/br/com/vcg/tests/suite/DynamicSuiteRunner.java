...
import br.com.vcg.tests.util.GenericComparator;
import br.com.vcg.tests.util.classpath.ClassPathFilter;
import br.com.vcg.tests.util.classpath.ClassPathScanner;
import br.com.vcg.tests.util.classpath.ClassPathScannerException;
