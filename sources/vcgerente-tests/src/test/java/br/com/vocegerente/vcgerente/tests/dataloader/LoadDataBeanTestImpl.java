...
public class LoadDataBeanTestImpl implements LoadDataBeanTestDef {
	...
	/* (non-Javadoc)
	 * @see br.com.vocegerente.vcgerente.tests.dataloader.cdi.LoadDataBeanTestDef#loadDataInTypeTest()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.vocegerente.vcgerente.tests.dataloader.cdi.LoadDataBeanTestDef#loadDataInMethodTest()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.vocegerente.vcgerente.tests.dataloader.cdi.LoadDataBeanTestDef#precedenceTest()
	 */
	@Override
